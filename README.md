...
### Modify by [luofeilong](https://github.com/luofeilong)
...
---
### The blog theme you may fall in love with, coming to Hexo. [Preview](http://luofeilong.github.io)
![](http://7xkznp.com1.z0.glb.clouddn.com/images%2Fweb.png)
...
``` bash
$ git clone https://github.com/luofeilong/hexo-theme-icarus.git themes/icarus
```
...
Icarus provides 8 built-in widgets:

- duoshuo_recent_comments
- duoshuo_recent_vistors
- recent_posts
- category
- archives
- tag
